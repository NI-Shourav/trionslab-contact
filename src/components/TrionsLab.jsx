...
export default function TrionsLab() {
  ...
  const translations = {
    ...
    bn: {
      ...
      typewriter: [
        "আধুনিক SaaS উদ্ভাবনের বিশ্বস্ত ঠিকানা",
        "স্মার্ট সলিউশনে কাজের গতিশীলতা বাড়ান কয়েক গুণ",
        "ইনোভেটিভ আইডিয়া থেকে সাকসেসফুল প্রোডাক্ট",
        "আপনার ব্যবসার প্রবৃদ্ধিতে প্রযুক্তিগত উৎকর্ষ",
        "পরবর্তী প্রজন্মের জন্য আধুনিক SaaS আর্কিটেকচার",
        "সৃজনশীল উদ্ভাবন ও শক্তিশালী অবকাঠামোর মেলবন্ধন",
        "ক্লাউড-নেটিভ টেকনোলজিতে গড়ছি আগামীর ভবিষ্যৎ",
        "ডিজিটাল ট্রান্সফরমেশনে আপনার নির্ভরযোগ্য পার্টনার",
      ],
      callNow: "কল",
      emailUs: "ইমেইল",
      findUs: "লোকেশন",
